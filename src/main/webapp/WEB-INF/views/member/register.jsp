...
<div class="col-md-12">
	<div class="widget p-lg">
		...
		<h4 class="m-b-lg"> Member Registration</h4>
		<p class="m-b-lg docs">아래 사항을 작성해주세요.</p>
			...
			<form action="register" method="post">
				...
				<div>
					...
					<input rows="" cols="" name="uname" id="uname"
						class="form-control"  required="required" placeholder="이름을 작성해주세요.">
				</div>
				<div>
					<lable> schoolname </lable>
					<input type="text" name="schoolname" id="schoolname" class="form-control"
						value="" required="required"placeholder="학교 이름을 작성해주세요.">
				</div>
				...
				<div class="form-group">
					...
					<input type="text" name="gradeclass" id="gradeclass" class="form-control" value=""
						required="required" placeholder="gradeclass을 작성해주세요.">
				</div>
				<div>
					<lable> uid </lable>
					<input rows="" cols="" name="uid" id="uid"
						class="form-control"  required="required"placeholder="uid을 작성해주세요.">
				</div>
				<div>
					<lable> upw </lable>
					<input type="text" name="upw" id="upw" class="form-control"
						value="" required="required"placeholder="upw를 작성해주세요.">
				</div>
				<div class="form-group">
					
					<lable> route </lable>
					<input type="text" name="route" id="" class="form-control" value=""
						required="required" placeholder="route을 작성해주세요.">
				</div>
				
				<div class="form-group">
					
					<lable> boardingplace </lable>
					<input type="text" name="boardingplace" id="" class="form-control" value=""
						required="required" placeholder="boardingplace을 작성해주세요.">
				</div>
